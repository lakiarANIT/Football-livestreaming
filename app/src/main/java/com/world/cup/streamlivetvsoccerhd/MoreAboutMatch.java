...
import com.world.cup.streamlivetvsoccerhd.adapters.OtherMatchesAdapters;
...
public class MoreAboutMatch extends AppCompatActivity {

    private RecyclerView recyclerView;
    private OtherMatchesAdapters matchesAdapters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_more_about_match);
        ...
        matchesAdapters=new OtherMatchesAdapters(mInterstitialAd,this,matchModelList);
    ...
    private void getData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Util._base_url, new com.android.volley.Response.Listener<JSONArray>() {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("x-rapidapi-key", "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
